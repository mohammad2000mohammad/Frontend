    ...
    const fetchUserData = async () => {
      ...
      try {
       // Get the token from localStorage or cookies
        ...
        const userResponse = await fetch(`https://backend-v6sz.onrender.com/api/users/${userId}`, {
          method:"Get",
          headers,
        });
        ...
        const ordersResponse = await fetch(`https://backend-v6sz.onrender.com/api/orders/user/${userId}`, {
          method:"Get",
          headers,
        });
  ...
  const handleDeleteUser = async () => {
    if (window.confirm("Are you sure you want to delete this user?")) {
      ...
      try {
        ...
        const response = await fetch(`https://backend-v6sz.onrender.com/api/users/${userId}`, {
          method: "DELETE",
          headers,
        });
        if (response.ok) {
